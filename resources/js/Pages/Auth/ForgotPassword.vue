...
<template>
    <AuthProcessLayout>
        <div class="">
            ...
            <h1 class="text-primary text-4xl text-center font-bold uppercase my-10">Reset password</h1>
            
            <form @submit.prevent="submit" class="my-10 flex flex-col space-y-4">
                <div class="">
                    <label for="email" class="text-xl text-gray-500">Enter your email</label> <br />
