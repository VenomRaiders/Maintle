    ...
    <ScriptWriterDashboardLayout>
        ...
        <div class="form-container">
            <div class="text-left w-full">
                <StandardButton text="Go Back" bg-color="var(--primary-color)" :is-link=true
                    :href="route('scriptwriter.dashboard')" style="width: fit-content;"></StandardButton>
            </div>
            <h1 v-if="$page.url == '/scriptwriter/first_script'" class="text-center text-2xl uppercase font-bold">Upload
                your first script for review</h1>
            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="form-inputs">
                    ...
                    <input type="file" name="" id="posterImage" @change="form.posterImage = $event.target.files[0]"
                ...
                <div class="form-inputs">
                    ...
                    <input type="file" name="" id="scriptDocument" @change="form.scriptDocument = $event.target.files[0]"
                        class="w-full rounded-md text-black">
                ...
                <div class="form-groups">
                    <div class="form-inputs">
                        ...
                        <input type="number" v-model="form.castSize" placeholder="- select a value size -" name=""
                            id="castSize">
                    ...
                    <div class="form-inputs">
                        ...
                        <input type="number" v-model="form.location" placeholder="- select a value size -" name="location"
                    ...
                    <div v-if="hasCopyRight" class="">
                        <div class="my-2 p-1 border">
                            <ul v-if="copyright.values.length != 0" class="h-48 overflow-y-scroll cursor-pointer">
                                <li v-for="cp in copyright.values" :key="cp" @click.prevent="removeCopyRight(cp)"
                ...
                <div v-if="showLeadRoles">
                    <div class="my-2 p-1 border">
                        <ul v-if="leadRoles.values.length != 0" class="h-48 overflow-y-scroll cursor-pointer">
                            <li v-for="leadrole in leadRoles.values" :key="leadrole"
                                @click.prevent="removeLeadRole(leadrole)" class="text-sm bg-slate-300 my-1">
                    ...
                    <div class="border my-2 p-1">
                        ...
                        <div class="form-inputs">
                            ...
                            <input type="text" v-model="singleLeadRole.characterName" name="characterName"
                                id="characterName">
                        </div>
                        ...
                        <div class="form-groups" style="margin-top: 20px;">
                            ...
                            Female
                            <input type="radio" name="female" id="femaleGender" value="female"
                                v-model="singleLeadRole.gender">
                        </div>
                ...
                <div class="my-8 flex justify-center submit">
                    ...
                    <input type="submit" value="Save" v-else
                        class="px-4 py-2 rounded-md bg-[var(--primary-color)] text-white text-center cursor-pointer">
                </div>
            </form>
        </div>
